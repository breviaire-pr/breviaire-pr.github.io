...
const UI_ENV = {
    title: 'Printemps—Bréviaire de Nicolas Le Tourneux',
    canonical: 'https://breviaire.sacy.be/printemps',
    dataBasePath:'',
    uiPath: '../ui',
    bookSelectorLabel: 'Part.',
    chapterSelectorLabel: 'À :',
    sites,
    links: [
        {
        ...
        },
        {
            ...
            url: 'https://github.com/breviaire-pr/breviaire-pr.github.io'
        },
        {
